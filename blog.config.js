...
const BLOG = {
  ...
  NOTION_ACCESS_TOKEN: process.env.NOTION_ACCESS_TOKEN || 'secret_Sj9Y7U8623Prk8TYE8HzHwYBMy6Pift8KHKuwu78xjo', // Useful if you prefer not to make your database public
